          ...
          return (
            ...
            >
              ...
              <div className="w-full aspect-square bg-cp-bg2 relative flex items-center justify-center border-b border-line overflow-hidden">
                {template.photo_url ? (
                  <img src={template.photo_url} alt="" className="w-full h-full object-cover" />
                ) : (
              ...
              <div className="flex-1 flex flex-col p-4">
                <div className="flex-1">
                  ...
                  <div className="space-y-1 mb-3 text-xs text-muted-foreground">
                    <p>{template.recipe_items.length} material{template.recipe_items.length !== 1 ? 'es' : ''}</p>
                    {dims.length === 3 && (
                      <p>{template.height_cm}×{template.width_cm}×{template.depth_cm} cm</p>
                    )}
                  </div>
                </div>
                ...
                {usedIn > 0 && (
                  <p className="text-xs text-muted-foreground mt-3 pt-3 border-t border-line">
                    <Link to={`/quotes?template=${template.id}`} className="underline hover:text-foreground">
